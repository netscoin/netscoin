...
uint256 hashGenesisBlock("0x33dfe3eb16f1dea13af49ab5c29a93419f78c5d548bf33679a4b8faab89433e5");
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "nets genesis block";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
...
unsigned char pchMessageStart[4] = { 0xd4, 0xca, 0xa4, 0xe1 };
